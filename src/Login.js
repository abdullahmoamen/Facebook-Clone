...
import './Login.css';
import facebookTextImg from '../src/assests/images/facebookTextImg.jpg'
    ...
    return (
        ...
        transition={{ delay: 0.2, type: 'spring', stiffness: 120 }}>
            <div className="login__logo">
                <motion.img src={facebookImg} 
                variants={imgVariants}
                initial="hidden"
                animate="visible"
                alt="facebookImg"/>
                <img src={facebookTextImg} 
                alt="facebookTextImg"/>
            </div>
            ...
            <h3>Login using Google Account</h3>
                ...
                whileHover="hover"
                onClick={signIn} type='submit'>Sign In</motion.button>
        </motion.div>
    )
}
